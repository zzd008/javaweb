...
<body>
	...
	<div class="about">
		...
		<div class="agileits-about-top">
			<div class="container">
				<div class="agileits-about-top-heading">
					<h3>共找到${SearchTipCount}条结果</h3>
				</div>
				<div class="agileinfo-top-grids">
					<c:forEach items="${SearchTipInfo }" varStatus="tp" var="t">
					...
					<c:if test="${SearchTipCount}!=0">
						<c:if test="${SearchTipCount<6}"><!-- 隐藏框 填充-->
							<c:forEach var="i" begin="${SearchTipCount}" end="5">
								<div class="col-sm-4 wthree-top-grid" style="height:500px; width:33.33%;" >
		...
		<div class="jarallax newsletter">
			<div class="w3-agileits-newsletter" style="margin-top: 18px">
